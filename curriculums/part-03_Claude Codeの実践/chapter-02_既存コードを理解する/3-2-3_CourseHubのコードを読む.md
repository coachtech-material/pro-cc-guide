...
Service クラスの設計原則（単一責任の原則、インターフェースの分離など）を今深掘りする必要はありません。[Chapter 3-5「コードを改善する」](../chapter-05_コードを改善する/3-5-0_Chapter%205の地図.md)（リファクタリング）で Fat Controller を改善するときに、必要に応じて深掘りします。
