...
>
> 複数の Chapter で異なるブランチを作成した場合は、PR を作成する前に1つのブランチに統合する必要があります。Claude Code に「[Chapter 3-3「バグを修正する」](../chapter-03_バグを修正する/3-3-0_Chapter%203の地図.md) から [Chapter 3-5「コードを改善する」](../chapter-05_コードを改善する/3-5-0_Chapter%205の地図.md) のブランチを1つにまとめたい」と相談すれば、マージの手順を案内してくれます。または、以下のように手動でまとめることもできます。
>
> ```bash
> git checkout main
