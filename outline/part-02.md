...
→ ハンズオン: 全 Chapter で cc-practice プロジェクトを一貫して使用。Chapter を通じてプロジェクトが自然に成長していく

### 🏃 実践の方針

- 全 Chapter の全 Section が混合パターン。「学ぶ→試す→確認する」のリズムで統一
- cc-practice プロジェクトを一貫して使い、各実践で明確な成果物（設定ファイル、Skill、Hook 等）を残す
- Chapter 2-1 → 2-2 → 2-3 と進むにつれ、実践の複雑さが自然に上がる

---

## Chapter 2-1: セットアップ（4 Section + 地図）

**ゴール**: Claude Code をインストールし、プロジェクトの土台を作り、最初のコード生成を体験する。

意図: セットアップの性質上「学ぶ→やる」を順次進める

- **2-1-0 Chapter 2-1 の地図**（Chapter 地図 / 学習者向けの導入ページ）
...
## Chapter 2-2: 基本を理解する（3 Section + 地図）

**ゴール**: Claude Code の動作原理、コンテキスト管理、プロンプト設計を理解し、効果的に使うための土台を作る。

意図: 概念を学んだ後 cc-practice で体験する混合型。日報管理機能を題材にエージェントループ・コンテキスト管理・プロンプト設計を体感する

- **2-2-0 Chapter 2-2 の地図**（Chapter 地図 / 学習者向けの導入ページ）
...
## Chapter 2-3: 機能を使いこなす（8 Section + 地図）

**ゴール**: Claude Code の主要機能を cc-practice で実践し、それぞれの機能を使いこなせるようにする。

- **2-3-0 Chapter 2-3 の地図**（Chapter 地図 / 学習者向けの導入ページ）
...
- **2-3-6 Plugins**
  ...
  - 🏃 実践: 公式マーケットプレイスから Plugin をインストールし、Plugin を作成する
